...
pub fn register_all(conn: &Connection) -> Result<()> {
    ...
    // Phase 2: 1207 names registered (15 shapes), 341 scalars deferred to Phase 3+ (55 unique shapes).
    Ok(())
}
...
//    132  [binary] -> int64
//     34  [binary,int64] -> binary
//     21  [binary,int64] -> boolean
//     18  [binary,int64] -> float64
//     17  [binary,float64] -> boolean
//     13  [binary,int64,int64] -> binary
